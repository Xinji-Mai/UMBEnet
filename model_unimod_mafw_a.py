...
from ConfusionMatrix import display_cls_confusion_matrix_6
...
class JMPF(pl.LightningModule):
    ...
    def forward(self,batch):
        ...
        if f_frames != None:
            ...
            video_features = torch.zeros(b,16,768).to(audio.device)
