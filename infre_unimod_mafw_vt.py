...
from typing import Optional
from model_unimod_mafw_vt import JMPF
import numpy as np
import io
import os
import glob
...
checkpoint = torch.load("/home/et23-maixj/mxj/JMPF_pooling/checkpoint/unimod_mafw_vt.ckpt", map_location = device) # 这里假设您的checkpoint文件名是best-checkpoint.ckpt，您可以根据您的实际文件名来修改
